...
class TodoApp extends Component {
    ...
    render() {
        return (
            <>
                <Header text="todos" />
                <Main filter={this.state.filter} clear={this.state.clear} changetodoNum={this.changetodoNum} changecompNum={this.changecompNum} changeclear={this.changeclear}/>
                <Footer todoNum={this.state.todoNum} compNum={this.state.compNum} changefilter={this.changefilter} changeclear={this.changeclear}/>
            </>
        );
    }
}
